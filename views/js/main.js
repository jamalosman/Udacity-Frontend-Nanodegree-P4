...
var multipliers;
var scrollTop;
// Returns an array of 5 multipliers for pizza positions based on scroll position
function getPositionMultipliers() {
    multipliers = [];
    scrollTop = document.body.scrollTop;
    for (var i = 0; i < 5; i++) {
        multipliers.push(100 * Math.sin((scrollTop / 1250) + (i)));
    };
    return multipliers;
}
...
// (The answer with the most upvotes as of 18-12-2015 (600))
